  ...
  return (
    <div className="bg-white rounded-2xl shadow-md p-8 max-w-xs w-full mx-auto">
      ...
      <div className="flex justify-center">
        <img
          src={parseInt(userId) % 2 === 1 ? avatar1 : avatar2}
      ...
      <button
        className="mt-8 w-full bg-teal-600 text-white font-semibold text-xl py-3 rounded-lg shadow-md transition hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400"
